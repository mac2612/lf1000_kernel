...
// Directions are from the perspective of the device turned sideways with dpad on the left.
#define MADRID_DPAD_DOWN_PORT		GPIO_PORT_C
#define MADRID_DPAD_DOWN_PIN		GPIO_PIN3
...
#define MADRID_DPAD_RIGHT_PIN		GPIO_PIN4
...
#define MADRID_DPAD_LEFT_PIN		GPIO_PIN29

#define MADRID_DPAD_UP_PORT		GPIO_PORT_A
#define MADRID_DPAD_UP_PIN		GPIO_PIN28
